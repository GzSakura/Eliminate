# Build script - Compile and package neoforge versions of the mod
...
if (Test-Path $modsPath) {
    ...
    if ($modFiles.Count -gt 0) {
        ...
        Write-Host "No build artifacts found, please check the build process."
    }
} else {
    Write-Host "build/mods directory does not exist, please check the build process."
}
