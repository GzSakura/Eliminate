# Neoforge Build Script (PowerShell)
...
if (-not (Test-Path $neoforgePath)) {
    Write-Host "Error: Neoforge directory not found: $neoforgePath" -ForegroundColor Red
...
Write-Host ""
Write-Host "========================================" -ForegroundColor Green
Write-Host "Neoforge build process completed" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
